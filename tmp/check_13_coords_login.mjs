...
await page.screenshot({ path: '.tmp_login_before_coords.png', fullPage: true });

// Login by coordinates on CanvasKit layout.
...
await page.screenshot({ path: '.tmp_login_after_coords.png', fullPage: true });
...
for (const panel of panels) {
  ...
  const file = `.tmp_13_coords_${panel}.png`;
